...
export const LearningGrid = () => {
  return (
    <div className="w-full py-20">
      <div className=" w-10/12 max-w-[1000px] grid mx-auto  grid-cols-4">
        {learningGridData.map((item, index) => (
          <div
            key={index}
            className={`${item.order === -1 && "col-span-2 bg-richblack-900"} ${
          ...
          >
            ...
            <div className=" text-richblack-100 text-sm">{item.description}</div>
